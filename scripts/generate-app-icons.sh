...
npx sharp -i ./src/images/app-icons/icon.png -o ./static/icons/android-chrome-512x512.png resize 512
...
npx sharp -i ./src/images/app-icons/icon.png -o ./static/icons/android-icon-144x144.png resize 144
