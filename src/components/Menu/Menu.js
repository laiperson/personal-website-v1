...
class Menu extends React.Component {
  constructor(props) {
    ...
    this.items = [
      ...
      { to: "/#about-me", label: "About", icon: FaTag },
      { to: "/#education", label: "Education", icon: FaSearch },
      { to: "/#experience", label: "Experience", icon: FaEnvelope },
      { to: "/#projects", label: "Projects", icon: FaTag }
    ];
